...
#[cfg(all(not(feature = "postgres-storage"), not(feature = "webhooks")))]
...
#[cfg(all(not(feature = "postgres-storage"), feature = "webhooks"))]
mod conditional_schemas {
    use super::*;
...
#[cfg(all(feature = "postgres-storage", not(feature = "webhooks")))]
mod conditional_schemas {
    use super::*;
...
#[cfg(all(feature = "postgres-storage", feature = "webhooks"))]
mod conditional_schemas {
    use super::*;
    // Submodules referenced directly for utoipa __path_* type resolution
    use crate::api::routes::conflicts;
